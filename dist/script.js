...
/* harmony import */ var _modules_showMore__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/showMore */ "./src/js/modules/showMore.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_7__["default"])('[name="name"]');
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_7__["default"])('[name="message"]');
  Object(_modules_showMore__WEBPACK_IMPORTED_MODULE_8__["default"])('.button-styles', '#styles .row');
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_9__["default"])('#size', '#material', '#options', '.promocode', '.calc-price');
  Object(_modules_pictureSize__WEBPACK_IMPORTED_MODULE_10__["default"])('.sizes-block');
...
var calc = function calc(size, material, option, promocode, result) {
  ...
  var calcFunct = function calcFunct() {
...
/* harmony default export */ __webpack_exports__["default"] = (forms); // Производим запрос на сервер, реагируем на загрузку, ошибку, отправку
// Останавливаем перезагрузку страницы при отправке, очищаем поля инпутов
// Данные отправляем в виде массива
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var trigger = document.querySelectorAll(triggerSelector),
        ...
        scroll = calcScroll(); // кнопка тригер
...
// таймер, модальное окно появляется через 60сек
...
var scrolling = function scrolling(upSelector) {
  ...
  }); // raf scroll (Request Animation frame)
...
var showMore = function showMore(trigger, wrapper) {
  var btn = document.querySelector(trigger); // серверная подгрузка (npx json-server src/assets/db.json)
...
/* harmony default export */ __webpack_exports__["default"] = (showMore); // локальная подгрузка
...
var sliders = function sliders(slides, dir, prev, next) {
  ...
  } catch (e) {} // при наведении мыши останавливаем слайдер
